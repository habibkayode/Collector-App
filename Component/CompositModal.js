      ...
      <ScrollView contentContainerStyle={styles.modalContainer}>
        ...
        <RNPickerSelect
          ...
          onValueChange={(value) => {
            ...
            let obj = props.compositeMaterial[classId];
            console.log(obj, "obj");
            if (obj) {
              ...
              if (itemFind) {
                setItemName(itemFind.item);
                setDescription(itemFind.description);
                console.log(
                  itemFind.producer_commission,
                  "price",
                  typeof itemFind.producer_commission
                );
                setPrice(itemFind.producer_commission);
              }
            }
          }}
          style={{
          ...
          items={
            classId
              ? props.compositeMaterial[classId].map((k) => {
                  return {
                    label: k.item,
                    value: k.id,
                    color: "black",
